...
- **Update the "Last synced" commit hash** in this document to `$HEAD` — in *two* places: the table
  above and the `BASELINE=` line in the snippet. Edit those two literally; do **not** do a
  find-and-replace-all of the old hash across this file, or you'll also rewrite the History row that
  legitimately records it (this happened in the 2026-08-24 and 2026-09-04 passes and had to be
  repaired).
